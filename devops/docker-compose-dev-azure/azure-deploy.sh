...
resourcename="genai01jc54vrt6zsa0hy45hhhn2mra"  # lower case, only
resourcegroup="genai01jc54vrt6zsa0hy45hhhn2mra_rg"
...
# git clone https://github.com/apilogicserver/genai01jc54vrt6zsa0hy45hhhn2mra.git
# cd genai01jc54vrt6zsa0hy45hhhn2mra
...
az group create --name genai01jc54vrt6zsa0hy45hhhn2mra_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group genai01jc54vrt6zsa0hy45hhhn2mra_rg --sku S1 --is-linux
az container create --resource-group genai01jc54vrt6zsa0hy45hhhn2mra_rg --name genai01jc54vrt6zsa0hy45hhhn2mra --image apilogicserver/genai01jc54vrt6zsa0hy45hhhn2mra:latest --dns-name-label genai01jc54vrt6zsa0hy45hhhn2mra --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//genai01jc54vrt6zsa0hy45hhhn2mra.westus.azurecontainer.io:5656'
